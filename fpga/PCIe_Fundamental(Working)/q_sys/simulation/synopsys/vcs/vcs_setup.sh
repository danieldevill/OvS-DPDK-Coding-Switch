...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/q_sys_mm_interconnect_1_avalon_st_adapter_error_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/q_sys_mm_interconnect_1_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/q_sys_pio_led.v \
  $QSYS_SIMDIR/submodules/q_sys_pio_key.v \
