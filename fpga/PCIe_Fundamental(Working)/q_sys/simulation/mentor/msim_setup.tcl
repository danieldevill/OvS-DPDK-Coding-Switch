...
# ----------------------------------------
# ACDS 18.1 625 linux 2019.08.15.16:36:47
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/q_sys_onchip_memory2_0.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/q_sys_mm_interconnect_1_avalon_st_adapter_error_adapter_0.sv"                 -work error_adapter_0                                                     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/q_sys_mm_interconnect_1_avalon_st_adapter.v"                                  -work avalon_st_adapter                                                   
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/q_sys_pio_led.v"                                                              -work pio_led                                                             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/q_sys_pio_key.v"                                                              -work pio_key                                                             
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L avalon_st_adapter -L router_003 -L avalon_st_adapter_001 -L limiter_pipeline -L pcie_cv_hip_avmm_0_Rxm_BAR0_to_onchip_memory2_0_s1_cmd_width_adapter -L rsp_mux_001 -L rsp_demux_001 -L cmd_mux_001 -L cmd_demux_001 -L onchip_memory2_0_s1_burst_adapter -L ctl_0_dma_read_master_0_data_read_master_limiter -L router_004 -L onchip_memory2_0_s1_agent_rsp_fifo -L onchip_memory2_0_s1_agent -L pcie_cv_hip_avmm_0_Rxm_BAR0_agent -L onchip_memory2_0_s1_translator -L pcie_cv_hip_avmm_0_Rxm_BAR0_translator -L dma_write_master_0 -L dma_read_master_0 -L modular_sgdma_dispatcher_0 -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L pio_led -L pio_key -L pcie_cv_hip_avmm_0 -L onchip_memory2_0 -L ctl_0 -L alt_xcvr_reconfig_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
