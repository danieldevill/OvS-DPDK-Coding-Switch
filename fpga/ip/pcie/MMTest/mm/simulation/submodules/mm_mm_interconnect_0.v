...
module mm_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                              // rsp_mux:src_data -> master_read_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                             // master_read_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                           // rsp_mux:src_channel -> master_read_avalon_master_agent:rp_channel
	...
	wire          rsp_mux_001_src_valid;                                                         // rsp_mux_001:src_valid -> master_write_avalon_master_agent:rp_valid
	wire  [101:0] rsp_mux_001_src_data;                                                          // rsp_mux_001:src_data -> master_write_avalon_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                         // master_write_avalon_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                       // rsp_mux_001:src_channel -> master_write_avalon_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                 // rsp_mux_001:src_startofpacket -> master_write_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                   // rsp_mux_001:src_endofpacket -> master_write_avalon_master_agent:rp_endofpacket
	...
	wire  [101:0] master_read_avalon_master_agent_cp_data;                                       // master_read_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] master_write_avalon_master_agent_cp_data;                                      // master_write_avalon_master_agent:cp_data -> router_001:sink_data
	...
	mm_mm_interconnect_0_router router (
	...
	mm_mm_interconnect_0_router router_001 (
	...
	mm_mm_interconnect_0_router_002 router_002 (
	...
	mm_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mm_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
