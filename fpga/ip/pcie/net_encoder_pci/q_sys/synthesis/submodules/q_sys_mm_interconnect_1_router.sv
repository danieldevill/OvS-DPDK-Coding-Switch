...
(
    ...
    localparam PAD1 = log2ceil(64'h6000020 - 64'h6000000); 
    localparam PAD2 = log2ceil(64'h6000030 - 64'h6000020); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h6000030;
    ...
    // ( 0x6000020 .. 0x6000030 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 27'h6000020  && write_transaction  ) begin
            src_channel = 3'b100;
