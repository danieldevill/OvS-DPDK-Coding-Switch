...
module q_sys_mm_interconnect_0 (
		...
		input  wire [31:0]  master_write_coeffs_avalon_master_address,                 //                   master_write_coeffs_avalon_master.address
		output wire         master_write_coeffs_avalon_master_waitrequest,             //                                                    .waitrequest
		input  wire [3:0]   master_write_coeffs_avalon_master_byteenable,              //                                                    .byteenable
		input  wire         master_write_coeffs_avalon_master_write,                   //                                                    .write
		input  wire [31:0]  master_write_coeffs_avalon_master_writedata,               //                                                    .writedata
	...
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_waitrequest;                       // master_write_coeffs_avalon_master_agent:av_waitrequest -> master_write_coeffs_avalon_master_translator:uav_waitrequest
	wire   [31:0] master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdata;                          // master_write_coeffs_avalon_master_agent:av_readdata -> master_write_coeffs_avalon_master_translator:uav_readdata
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_debugaccess;                       // master_write_coeffs_avalon_master_translator:uav_debugaccess -> master_write_coeffs_avalon_master_agent:av_debugaccess
	wire   [31:0] master_write_coeffs_avalon_master_translator_avalon_universal_master_0_address;                           // master_write_coeffs_avalon_master_translator:uav_address -> master_write_coeffs_avalon_master_agent:av_address
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_read;                              // master_write_coeffs_avalon_master_translator:uav_read -> master_write_coeffs_avalon_master_agent:av_read
	wire    [3:0] master_write_coeffs_avalon_master_translator_avalon_universal_master_0_byteenable;                        // master_write_coeffs_avalon_master_translator:uav_byteenable -> master_write_coeffs_avalon_master_agent:av_byteenable
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdatavalid;                     // master_write_coeffs_avalon_master_agent:av_readdatavalid -> master_write_coeffs_avalon_master_translator:uav_readdatavalid
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_lock;                              // master_write_coeffs_avalon_master_translator:uav_lock -> master_write_coeffs_avalon_master_agent:av_lock
	wire          master_write_coeffs_avalon_master_translator_avalon_universal_master_0_write;                             // master_write_coeffs_avalon_master_translator:uav_write -> master_write_coeffs_avalon_master_agent:av_write
	wire   [31:0] master_write_coeffs_avalon_master_translator_avalon_universal_master_0_writedata;                         // master_write_coeffs_avalon_master_translator:uav_writedata -> master_write_coeffs_avalon_master_agent:av_writedata
	wire    [2:0] master_write_coeffs_avalon_master_translator_avalon_universal_master_0_burstcount;                        // master_write_coeffs_avalon_master_translator:uav_burstcount -> master_write_coeffs_avalon_master_agent:av_burstcount
	wire          rsp_mux_003_src_valid;                                                                                    // rsp_mux_003:src_valid -> master_write_coeffs_avalon_master_agent:rp_valid
	wire  [114:0] rsp_mux_003_src_data;                                                                                     // rsp_mux_003:src_data -> master_write_coeffs_avalon_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                                                    // master_write_coeffs_avalon_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [5:0] rsp_mux_003_src_channel;                                                                                  // rsp_mux_003:src_channel -> master_write_coeffs_avalon_master_agent:rp_channel
	wire          rsp_mux_003_src_startofpacket;                                                                            // rsp_mux_003:src_startofpacket -> master_write_coeffs_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                                                              // rsp_mux_003:src_endofpacket -> master_write_coeffs_avalon_master_agent:rp_endofpacket
	...
	wire          master_write_coeffs_avalon_master_agent_cp_valid;                                                         // master_write_coeffs_avalon_master_agent:cp_valid -> router_003:sink_valid
	wire  [114:0] master_write_coeffs_avalon_master_agent_cp_data;                                                          // master_write_coeffs_avalon_master_agent:cp_data -> router_003:sink_data
	wire          master_write_coeffs_avalon_master_agent_cp_ready;                                                         // router_003:sink_ready -> master_write_coeffs_avalon_master_agent:cp_ready
	wire          master_write_coeffs_avalon_master_agent_cp_startofpacket;                                                 // master_write_coeffs_avalon_master_agent:cp_startofpacket -> router_003:sink_startofpacket
	wire          master_write_coeffs_avalon_master_agent_cp_endofpacket;                                                   // master_write_coeffs_avalon_master_agent:cp_endofpacket -> router_003:sink_endofpacket
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) master_write_coeffs_avalon_master_translator (
		.clk                    (pcie_cv_hip_avmm_0_coreclkout_clk),                                                    //                       clk.clk
		.reset                  (master_read_clock_reset_reset_reset_bridge_in_reset_reset),                            //                     reset.reset
		.uav_address            (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (master_write_coeffs_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (master_write_coeffs_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (master_write_coeffs_avalon_master_byteenable),                                         //                          .byteenable
		.av_write               (master_write_coeffs_avalon_master_write),                                              //                          .write
		.av_writedata           (master_write_coeffs_avalon_master_writedata),                                          //                          .writedata
		.av_burstcount          (1'b1),                                                                                 //               (terminated)
		.av_beginbursttransfer  (1'b0),                                                                                 //               (terminated)
		.av_begintransfer       (1'b0),                                                                                 //               (terminated)
		.av_chipselect          (1'b0),                                                                                 //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) master_write_coeffs_avalon_master_agent (
		.clk                   (pcie_cv_hip_avmm_0_coreclkout_clk),                                                    //       clk.clk
		.reset                 (master_read_clock_reset_reset_reset_bridge_in_reset_reset),                            // clk_reset.reset
		.av_address            (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (master_write_coeffs_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (master_write_coeffs_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (master_write_coeffs_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (master_write_coeffs_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (master_write_coeffs_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (master_write_coeffs_avalon_master_agent_cp_ready),                                     //          .ready
	...
	q_sys_mm_interconnect_0_router_001 router_003 (
		.sink_ready         (master_write_coeffs_avalon_master_agent_cp_ready),          //      sink.ready
		.sink_valid         (master_write_coeffs_avalon_master_agent_cp_valid),          //          .valid
		.sink_data          (master_write_coeffs_avalon_master_agent_cp_data),           //          .data
		.sink_startofpacket (master_write_coeffs_avalon_master_agent_cp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (master_write_coeffs_avalon_master_agent_cp_endofpacket),    //          .endofpacket
		.clk                (pcie_cv_hip_avmm_0_coreclkout_clk),                         //       clk.clk
		.reset              (master_read_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
