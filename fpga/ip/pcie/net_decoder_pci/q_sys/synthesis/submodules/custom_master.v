...
begin
	...
	begin
		...
		defparam a_latency_aware_write_master.DATAWIDTH = DATA_WIDTH;
		defparam a_latency_aware_write_master.BYTEENABLEWIDTH = DATA_WIDTH/8;
		defparam a_latency_aware_write_master.ADDRESSWIDTH = ADDRESS_WIDTH;
		defparam a_latency_aware_write_master.FIFODEPTH = FIFO_DEPTH;
		defparam a_latency_aware_write_master.FIFODEPTH_LOG2 = FIFO_DEPTH_LOG2;
		defparam a_latency_aware_write_master.FIFOUSEMEMORY = MEMORY_BASED_FIFO;
	end
end
endgenerate
