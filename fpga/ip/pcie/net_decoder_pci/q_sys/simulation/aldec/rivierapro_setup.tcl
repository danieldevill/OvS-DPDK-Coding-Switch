...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/q_sys_mm_interconnect_0_rsp_mux_004.sv"                                       -work rsp_mux_004                                                         
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work cmd_mux                                                             
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/q_sys_mm_interconnect_0_cmd_demux_004.sv"                                     -work cmd_demux_004                                                       
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/q_sys_mm_interconnect_0_router_007.sv"                                        -work router_007                                                          
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L error_adapter_0 -L rsp_mux -L cmd_mux -L cmd_demux -L router_001 -L router -L avalon_st_adapter_002 -L rsp_demux -L router_003 -L avalon_st_adapter_001 -L avalon_st_adapter -L limiter_pipeline -L pcie_cv_hip_avmm_0_Rxm_BAR0_to_onchip_memory2_0_s1_cmd_width_adapter -L rsp_mux_004 -L rsp_mux_001 -L rsp_demux_001 -L cmd_mux_001 -L cmd_demux_004 -L cmd_demux_001 -L onchip_memory2_0_s1_burst_adapter -L ctl_0_dma_read_master_0_data_read_master_limiter -L router_007 -L router_006 -L router_004 -L onchip_memory2_0_s1_agent_rsp_fifo -L onchip_memory2_0_s1_agent -L pcie_cv_hip_avmm_0_Rxm_BAR0_agent -L onchip_memory2_0_s1_translator -L pcie_cv_hip_avmm_0_Rxm_BAR0_translator -L dma_write_master_0 -L dma_read_master_0 -L modular_sgdma_dispatcher_0 -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L pio_coder_rst -L pcie_cv_hip_avmm_0 -L onchip_memory2_0 -L master_read -L ctl_0 -L alt_xcvr_reconfig_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
